// Path: android/app/src/main/java/com/vitalyiam/Maap/ar/BackgroundRenderer.kt
...
class BackgroundRenderer {
    ...
    init {
        ...
        val bbTexCoords = ByteBuffer.allocateDirect(numVertices * 2 * FLOAT_SIZE)
        bbTexCoords.order(ByteOrder.nativeOrder())
        quadTexCoords = bbTexCoords.asFloatBuffer()
        quadTexCoords.put(QUAD_TEXCOORDS)
        quadTexCoords.position(0)

        val bbTexCoordsTransformed = ByteBuffer.allocateDirect(numVertices * 2 * FLOAT_SIZE)
    ...
    fun draw(frame: Frame) {
        ...
        GLES20.glVertexAttribPointer(positionHandle, COORDS_PER_VERTEX, GLES20.GL_FLOAT, false, 0, quadCoords)
